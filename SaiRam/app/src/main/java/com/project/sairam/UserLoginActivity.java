...
public class UserLoginActivity extends AppCompatActivity {
    ...
    String finalResult ;
    String HttpURL = "https://dropping-dozens.000webhostapp.com/User/UserLogin.php";
    //String HttpURL = "https://10.19.80.23/User/UserLogin.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //sign = (TextView)findViewById(R.id.tvRegister);
    ...
    public void clickhere (View view) { startActivity(new Intent(UserLoginActivity.this, MainActivity.class));
    }
